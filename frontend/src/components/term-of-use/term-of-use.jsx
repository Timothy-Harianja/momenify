    ...
    return (
      <div className="term-of-use">
        ...
        <body id="body">
          ...
          when you visit our website Momenify, including any other media form,
          media channel, mobile website, or mobile application related or
          connected thereto Momenify. Please read this privacy policy carefully.
        ...
        <body id="body">
          ...
          updated Privacy Policy on the Momenify, and you waive the right to
        ...
        <body id="body">
          ...
          any revised Privacy Policy by your continued use of the Momenify after
          the date such revised Privacy Policy is posted.
        </body>

        <body id="body">
          We may collect information about you in a variety of ways. The
          information we may collect on the Momenify includes:
        </body>
        ...
        <body id="body">
          ...
          you voluntarily give to us when you register with the Momenify or when
          you choose to participate in various activities related to the
          Momenify such as online chat and message boards. You are under no
          ...
          features of the Momenify.
        </body>
        <body id="body">
          Information our servers automatically collect when you access the
          Momenify, such as your IP address, your browser type, your operating
          system, your access times, and the pages you have viewed directly
          before and after accessing the Momenify.
        </body>

        <body id="body">
          The Momenify may by default access your Momenify basic account
        ...
        <body id="body">
          ...
          information collected about you via the Momenify to: Administer
          sweepstakes, promotions, and contests. Assist law enforcement and
          respond to subpoena. Compile anonymous statistical data and analysis
          for use internally or with third parties. Create and manage your
          account. Deliver targeted advertising, coupons, newsletters, and other
          information regarding promotions and the Momenify to you. Email you
          regarding your account or order. Enable user-to-user communications.
          Generate a personal profile about you to make future visits to the
          Momenify more personalized. Increase the efficiency and operation of
          the Momenify. Monitor and analyze usage and trends to improve your
          experience with the Momenify. Notify you of updates to the Momenify.
          Offer new products, services, and/or recommendations to you. Perform
          other business activities as needed. Prevent fraudulent transactions,
          monitor against theft, and protect against criminal activity. Request
          feedback and contact you about your use of the Momenify. Resolve
          disputes and troubleshoot problems. Respond to product and customer
          service requests. Send you a newsletter. Solicit support for the
          Momenify. Others are also included in this list.
        </body>
        ...
        <body id="body">
          If you interact with other users of the Momenify, those users may see
        ...
        <body id="body">
          When you post comments, contributions or other content to Momenify,
          your posts may be viewed by all users and may be publicly distributed
          outside the Momenify in perpetuity.
        </body>

        <body id="body">
          We may use third-party advertising companies to serve ads when you
          visit the Momenify. These companies may use information about your
          visits to the Momenify and other websites that are contained in web
        ...
        <body id="body">
          ...
          technologies on Momenify to help customize the Momenify and improve
          your experience. When you access the Momenify, your personal
          ...
          availability and functionality of the Momenify. You may not decline
          web beacons. However, they can be rendered ineffective by declining
          all cookies or by modifying your web browser’s settings to notify you
        ...
        <body id="body">
          ...
          tracking technologies and remarketing services on the Momenify through
          the use of first party cookies and third-party cookies, to, among
          other things, analyze and track users’ use of the Momenify, determine
          the popularity of certain content and better understand online
          activity. By accessing the Momenify, you consent to the collection and
          ...
          for responses to your questions. We do not transfer personal
        ...
        <body id="body">
          The Momenify may contain links to third-party websites and
          ...
          links to leave the Momenify, any information you provide to these
        ...
        <body id="body">
          ...
          you set the DNT signal on your browser, we will respond to such DNT
          browser signals.
        </body>
        ...
        <body id="body">
          ...
          updating your account and contacting us using the contact information
